 ...
 */
public final class ParameterInserterFactory implements ParameterInserterProvider {
     ...
     */
    @Inject
    public ParameterInserterFactory(final ServiceLocator locator) {
        this.paramConverterFactory
                = Values.lazy(new Value<ParamConverterFactory>() {
                    @Override
                    public ParamConverterFactory get() {
                        return new ParamConverterFactory(locator);
                    }
                });
    }
