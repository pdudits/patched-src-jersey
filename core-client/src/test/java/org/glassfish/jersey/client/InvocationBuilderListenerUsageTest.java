...
public class InvocationBuilderListenerUsageTest {
    ...
    static class ContextPropagator implements InvocationBuilderListener {

        @Override
        public void onNewBuilder(InvocationBuilderContext context) {
            context.property(KEY, Thread.currentThread().getName());
        }
    }
